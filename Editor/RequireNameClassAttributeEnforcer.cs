...
namespace Ikonoclast.ClassAttributes.Editor
{
    ...
    internal sealed class RequireNameClassAttributeEnforcer : IClassAttributeEnforcer
    {
        ...
        private static readonly Dictionary<string, string>
            ...
            {
                { nameof(enabled), $"{nameof(RequireNameClassAttributeEnforcer)}.{nameof(Enabled)}" },
                { nameof(enforceOnSceneChange), $"{nameof(RequireNameClassAttributeEnforcer)}.Enforce On Scene Change" },
                { nameof(enforceOnSelectionChange), $"{nameof(RequireNameClassAttributeEnforcer)}.Enforce On Selection Change" },
            };
